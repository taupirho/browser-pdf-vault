        ...
        <div className="space-y-6">
          ...
          <Card className="shadow-card bg-gradient-card border-border/50">
            <CardContent className="p-8 space-y-6">
              ...
              <div>
                <h3 className="font-semibold text-lg mb-3">Your Responsibility</h3>
              ...
              <div>
                <h3 className="font-semibold text-lg mb-3">No Data Storage</h3>
              ...
              <div>
                <h3 className="font-semibold text-lg mb-3">Security & Encryption</h3>
                <p>PDFs are encrypted using the AES-256 algorithm implemented in the open-source pdf-lib-plus-encrypt library. We strongly recommend saving your password in a secure location—if it is lost, we cannot help you recover access to the document.</p>
              </div>

              <div>
                <h3 className="font-semibold text-lg mb-3">Copyright & DMCA Compliance</h3>
                <p>SecurePDF is a tool for legitimate document protection. You may only process content you own or have explicit permission to modify. We do not facilitate copyright infringement. If you believe copyrighted material is being processed through our service, contact us at securemypdfdoc@gmail.com with details.</p>
              </div>

              <div>
                <h3 className="font-semibold text-lg mb-3">Acceptable Use Policy</h3>
                <p>You agree not to use SecurePDF to:</p>
                <ul className="list-disc pl-6 mt-2 space-y-1">
                  <li>Process documents containing illegal content under UK or international law</li>
              ...
              <div>
                <h3 className="font-semibold text-lg mb-3">Disclaimer of Warranties</h3>
              ...
              <div>
                <h3 className="font-semibold text-lg mb-3">Changes to the Service</h3>
                <p>We may modify, suspend, or discontinue the service at any time without notice. Updated Terms of Service will be posted on this page and become effective upon publication.</p>
              </div>
